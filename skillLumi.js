...
sklm.getskilldesc1Lumi = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 5:
            ...
            break;
        case 6:
            rep = "좌우 170, 상하 320 / 텔레포트 후 짧은 시간 동안 투명화";
            break;
        case 7:
        ...
        case 17:
            ...
            break;
        case 18:
            rep = "상태 이상 3회 무시 / 쿨300초, [패시브효과 : 속성내성40%, 내성40증가]";
            break;
        case 19:
        ...
        case 22:
            ...
            break;
        case 23:
            rep = "[빛 마법] 최대 8명의 적을 400% 데미지로 4번 공격";
            break;
        case 24:
            rep = "[어둠 마법] 8명,180%,2번 밀어내면서 공격하다가 터지면서 370% 데미지";
            break;
        case 25:
            rep = "[어둠 마법] 최대 8명의 적에게 340% 데미지로 7번 공격";
            break;
        case 26:
            rep = "[이퀄리브리엄] 2명,385%,7번 공격 /추가크확100%, 방무 40% 추가";
            break;
        case 27:
            rep = "180초동안 내성10% 무시 / [패시브효과 : 최종데미지 40%증가, 방무 40%]";
            break;
        case 28:
        ...
        case 31:
            ...
            break;
        case 32:
            rep = "40초동안 12명의 적을 550%의 데미지로 10번 공격 / 1명의 경우 825%";
            break;
        case 33:
            rep = "6초동안 10명,일정주기마다 공격 마법진 소환 / 추가크확 15% / 쿨30초";
            break;
        case 34:
            rep = "825%,7번 검 13번 연속 발동 / 추가크확100%, 방무100%, 쿨45초";
            break;
        case 35:
            rep = "[액티브]45초간마력구체10개사출,최대20번,추가크확100%,불1060%,균1085%";
            break;
    }
    return rep;
};
sklm.getskilldesc2Lumi = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 5:
            ...
            break;
        case 6:
            rep = "[패시브 효과 : 이동속도 20, 점프력 10만큼 증가]";
            break;
        case 7:
        ...
        case 23:
            ...
            break;
        case 24:
            rep = "쿨타임 5초 / [패시브 효과 : 최종 데미지 30% 증가]";
            break;
        case 25:
            rep = "\"사라져라.\" / \"아포칼립스!\"";
            break;
        ...
        case 32:
            ...
            break;
        case 33:
            rep = "S:770%,4번(좌우)/E:550%,5번(상하)/EQ:730%,6번(十자)/라크니스 실시간적용";
            break;
        case 34:
            rep = "앱솔루트 킬 12번 적중 시 빛과 어둠의 세례 쿨타임 즉시 초기화";
            break;
        case 35:
            rep = "[패시브]825%,4번/쿨타임6초/속성당 마력4획득/빛3명,어둠7명/쿨180초";
            break;
    }
    return rep;
};
