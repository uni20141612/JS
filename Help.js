...
help.gethelp = function(){
    ...
    help += "!곳폽 [숫자] : 랜덤으로 입력한 숫자만큼의 닉네임을 생성합니다. 2~6사이의 숫자를 입력할 수 있습니다.\n\n";
    help += "!날씨 (지역) : 그 지역 날씨를 보여줍니다. \n\n";
    help += "!날짜/!시간 : 현재 날짜/시간을 보여줍니다.\n\n";
    ...
    help += "!디데이 (날짜) : 입력한 날짜까지의 D-Day를 보여줍니다. 날짜는 yyyymmdd 형식으로 입력해주세요 (예 : 20220205)\n\n";
    help += "!렙반감 (항목) : 레벨별 해당 항목의 증감표를 보여줍니다.\n데미지 : 레벨별 데미지 증감표\n리부트 : 레벨별 리부트월드 데미지 증감표\n경험치 : 레벨별 경험치 증감표\n메소 : 레벨별 메소 증감표\n\n";
    ...
    help += "!롤/!그님티 (롤닉네임) : 해당 아이디의 티어를 보여줍니다.\n\n";
    help += "!마릿수/!몹젠 (지역) : (지역)의 몹젠과 경험치 획득 표를 보여줍니다.\n목록 : 아케인리버 지역, 세르니움(전/후), 호텔 아르크스\n\n";
    help += "!메모 (확인/삭제/메모내용) : 메모를 입력할 수 있습니다.\n'확인'을 입력하면 메모내용을 확인할 수 있습니다.\n'삭제'를 입력하면 메모내용을 삭제할 수 있습니다.\n\n";
    help += "!메소/!메소시세 (월드이름) : 해당 월드의 메소마켓, ㅁㅌ 시세를 알려줍니다. (머쉬빌리지 기준)\n(월드이름)에 '평균'을 입력하면 전체월드 평균 가격을 보여줍니다.\n\n";
    help += "!몬스터/!몹/!체력 (지역이름) (몬스터번호) [리부트여부] : 해당 지역의 해당 몬스터의 체력과 경험치 정보를 보여줍니다. 아케인리버와 그란디스 260레벨이상 지역에 한정하며, 몬스터는 번호로 입력할 수 있습니다. 리부트월드는 몬스터번호 뒤에 한칸 띄우고 아무글자나 입력하면 리부트월드의 해당 몬스터 체력과 경험치 배율을 곱한 값을 보여줍니다.\n몬스터 이름을 생략하면 해당 지역의 몬스터 목록을 보여줍니다.\n몬스터 이름에 (플)이 붙은 몬스터는 해당 지역의 플라잉 몬스터입니다. 피격시 물약 봉인과 HP비례 10%의 데미지를 입습니다.\n\n"
    help += "!무릉 (층수) : 1~100사이의 숫자를 넣으면 해당 층수의 몬스터 정보를 보여줍니다.\n\n";
    help += "!무스토리/!무릉스토리 (캐릭터이름) : 해당 캐릭터의 메지지 기준 무릉 히스토리를 보여줍니다.\n\n";
    help += "!무토 : 배고픈 무토 컨텐츠의 요리와 재료 목록을 보여줍니다.\n\n";
    help += "!문제 : 시드 39층에서 출제되는 메이플스토리 관련 문제들을 풀어볼수 있습니다.\n!답 (숫자 1,2,3,4) 를 입력하여 답을 맞출수 있습니다.\n\n";
    help += "!뭐먹지/!머먹지 : 보마봇의 식사 추천메뉴를 보여줍니다.\n\n";
    ...
    help += "!봇업데이트/!봇업뎃 : 최근 봇 업데이트 내역을 보여줍니다.\n\n";
    ...
    help += "!비약 (비약종류) (레벨) : 성장의 비약을 사용하였을 때 해당 레벨 0%에서 경험치가 얼마나 오르는지 알 수 있습니다. 레벨은 200이상의 숫자로 입력해주세요.\n1 : 극한 성장의 비약(200~249)\n2 : 태풍 성장의 비약(200~239)\n3 : 성장의 비약 3(200~229)\n4 : 성장의 비약 2(200~219)\n5 : 성장의 비약 1(200~209)\n6 : 익스트림 성장의 비약(141~199)\n\n";
    ...
    help += "!스타시뮬 A B C D E F : !스타포스와 동일하나, C에 목표 횟수를 기입하면 B부터 C회 강화하는 시뮬레이션을 보여줍니다.\n\n";
    ...
    help += "!시드정보 (층수) : 더 시드 컨텐츠의 해당 층수의 정보를 보여줍니다.\n\n";
    ...
    help += "!영어로/!영어 (단어) : 단어의 한영사전 검색결과를 보여줍니다.(결과가 불완전할 가능성이 높습니다.)\n\n";
    help += "!운빨 (확률) (시행횟수) [성공횟수] : 해당 확률(0<x<1)을 입력한 시행횟수(1<=y<=150)만큼 시도했을 때 입력한 성공횟수(1<=z<=y)만큼 성공한 것의 누적 이항 확률(상위 등급)을 구합니다. 성공횟수를 생략할 경우 1회 성공한 것으로 간주합니다. (예시 [레전 등업확률 1%의 블랙큐브 100개로 3개의 아이템 레전 등업에 성공하였을 경우] : !운빨 0.01 100 3)\n\n";
    help += "!원주율/!파이 [숫자] : 원주율을 입력한 숫자의 소수점 자리까지 보여줍니다. 생략 시 100자리까지 보여줍니다.\n\n";
    help += "!이벤트/!ㅇㅂㅌ : 현재 진행중인 이벤트를 보여줍니다.\n\n"
    help += "!익성비 (레벨) : 해당 레벨에서 익스트림 성장의 비약 사용 결과를 시뮬레이션 합니다.  (141~199 사이의 숫자를 입력해주세요.)\n\n";
    help += "!직업추천 [옵션] : 메이플스토리에 존재하는 직업 중에 무작위로 추첨을 하여 보여줍니다. 옵션은 전사, 마법사, 궁수, 도적, 해적, 힘(STR), 인트(INT), 덱스(DEX), 럭(LUK), 특수 중에서 고를수 있습니다. 생략하면 전체 중에서 무작위로 추첨합니다.\n\n";
    ...
    help += "!코디시뮬 : 메이플 코디 시뮬레이션을 할 수 있는 사이트를 안내합니다.\n\n";
    help += "!코로나 : 일일 코로나 현황을 보여줍니다.\n\n";
    ...
    help += "!퀴즈 [답] : 인물퀴즈를 진행합니다. 퀴즈는 방을 기준으로 진행되며 아무나 정답을 맞출 수 있습니다.\n\n"
    help += "!편의점 : CU/7-ELEVEN 편의점의 상품 목록중에 무작위로 한가지를 추첨하여 가격과 함께 보여줍니다.\n\n";
...
help.getInst = function(){
    ...
    inst += "!몬스터/!몹/!체력 (지역이름) (몬스터번호) [리부트여부]\n";
    inst += "!무릉 (층수(1~100))\n";
    inst += "!무스토리/!무릉스토리 (캐릭터이름)\n";
    inst += "!무토\n";
    inst += "!문제\n";
    inst += "!답 (1,2,3,4)\n";
    inst += "!뭐먹지/!머먹지\n";
