...
sk.getJobskillList = function(ind) {
    ...
    case 15:
        ...
        break;
    case 16:
        rep = "소울마스터\n\n1차 : 라이징 선, 폴링 문, 솔라 슬래시, 루나 디바이드, 엘리멘트 : 소울, 소울 가디언, 이너 보이스, 소울 리프\n2차 : 셀레스티얼 비전, 코스믹 매터, 솔루나 타임, 소울 블레싱, 님블 핑거, 이너 트러스트\n3차 : 셀레스티얼 비전 II, 코스믹 샤워, 라우드 러쉬, 사일런트 무브, 트루 사이트, 소울 블레싱 II, 솔루나 마스터리, 윌 오브 스틸, 이너 샤우트\n4차 : 셀레스티얼 비전 III, 코스믹 버스트, 솔루나 슬래시, 소울 페네트레이션, 소울 블레싱 III, 소울 플레지, 인포시어블, 마스터 오브 더 소드\n하이퍼 스킬 : 코스믹 포지, 블레이징 어썰트, 러스터 차지\n5차 : 코스모스, 엘리시온, 소울 이클립스, 플레어 슬래시";
        break;
    case 17:
        rep = "플레임위자드\n\n1차 : 오비탈 플레임, 파이어워크, 엘리멘트 : 플레임, 불의 반발력\n2차 : 오비탈 플레임 II, 플레임 볼텍스, 오비탈 익스플로전, 파이어 블링크, 번 앤 레스트, 엘리멘트 : 플레임 II\n3차 : 오비탈 플레임 III, 플레임 템페스타, 마엘스트롬, 본 피닉스, 엘리멘트 : 플레임 III, 해방된 마력, 약점 분석, 번뜩이는 깨달음\n4차 : 오비탈 플레임 IV(사자), 오비탈 플레임 IV(여우), 블레이징 익스팅션, 인페르노라이즈(사자), 인페르노라이즈(여우), 스피릿 오브 플레임, 버닝 리젼, 플레임 배리어, 엘리멘트 : 플레임 IV, 꺼지지 않는 화염\n하이퍼 스킬 : 피닉스 드라이브, 카타클리즘\n5차 : 블레이징 오비탈 플레임, 플레임 디스차지, 인피니티 플레임 서클, 샐리맨더 미스칩";
        break;
    case 18:
        rep = "윈드브레이커\n\n1차 : 윈드 워크, 거스트 쉬프트, 엘리멘트 : 스톰, 위스퍼 오브 더 윈드\n2차 : 스파이럴 볼텍스, 트라이플링 윔 I, 실프스 에이드\n3차 : 서리바람의 군무, 핀포인트 피어스, 트라이플링 윔 II, 알바트로스, 에메랄드 플라워, 페더리니스, 세컨드 윈드\n4차 : 페어리 턴, 천공의 노래, 트라이플링 윔 III, 스톰 브링어, 윈드 블레싱, 에메랄드 더스트, 알바트로스 맥시멈\n하이퍼 스킬 : 스톰 윔, 몬순\n5차 : 하울링 게일, 아이들 윔, 윈드 월, 볼텍스 스피어";
        break;
    case 19:
        rep = "나이트워커\n\n1차 : 엘리멘트 : 다크니스, 쉐도우 배트, 쉐도우 점프, 다크 사이트, 래피드 이베이젼, 헤이스트\n2차 : 스타더스트, 배트 커뮤니온, 다크니스 어뎁팅\n3차 : 쉐도우 서번트, 다크니스 어센션, 쉐도우 모멘텀, 배트 커뮤니온 II, 다크니스 어뎁팅 II, 스피릿 스로잉, 래디컬 다크니스, 아드레날린\n4차 : 퀸터플 스로우, 다크니스 오멘, 쉐도우 스티치, 래버너스 배트, 배트 커뮤니온 III, 다크니스 어뎁팅 III, 사이펀 바이탈리티, 다크니스 블레싱, 쉐도우 어시밀레이션\n하이퍼 스킬 : 쉐도우 일루전, 도미니언\n5차 : 쉐도우 스피어, 쉐도우 서번트 익스텐드, 쉐도우 바이트, 래피드 스로우";
        break;
    case 20:
        rep = "스트라이커\n\n1차 : 섬광, 엘리멘트 : 라이트닝, 뇌인\n2차 : 회축, 파도, 해파, 단련, 뇌백\n3차 : 승천, 뇌성, 질풍, 와류, 극갑, 연쇄, 뇌제\n4차 : 섬멸, 벽력, 태풍, 축뢰, 자극, 뇌신\n하이퍼 스킬 : 천지개벽, 해신강림\n5차 : 신뇌합일, 교아탄, 뇌신창격, 창뇌연격";
        break;
    case 21:
        rep = "미하일\n\n0차 : 여제의 기도, 빛의 수호\n1차 : 로얄 가드, 소울 점프, 소울 실드, 소울 어택\n2차 : 샤이닝 체이스, 버티컬 샤이닝 체이스, 인커리지\n3차 : 매직 크래쉬, 소울 링크, 어드밴스드 로얄 가드, 로얄 오쓰, 어드밴스드 소울 어택, 오펜시브 디펜스\n4차 : 샤이닝 크로스, 샤이닝 크로스-어썰트, 소울 레이지, 인스톨 실드, 어드밴스드 오펜시브 디펜스, 어드밴스드 소울 실드, 컴뱃 마스터리, 스탠스\n하이퍼 스킬 : 소울 마제스티, 데들리 차지, 퀸 오브 투모로우\n5차 : 로 아이아스, 클라우 솔라스, 소드 오브 소울 라이트, 라이트 오브 커리지";
        break;
    case 22:
        rep = "블래스터\n\n1차 : 매그넘 펀치, 리볼빙 캐논, 릴리즈 파일 벙커, 더블 점프, 익스플로젼 무브, 인듀어런스 실드\n2차 : 더블 팡, 더킹, 차지 마스터리, 리볼빙 캐논 업그레이드\n3차 : 해머 스매시, 스웨이, 리프트 프레스, 매그넘 캐논, 리볼빙 캐논 업그레이드 II, 인듀어런스 트레이닝, 콤비네이션 트레이닝\n4차 : 쇼크 웨이브 펀치, 플래시 무브, 허리케인 믹서, 리볼빙 벙커, 슈퍼 인듀어런스, 리볼빙 캐논 업그레이드 III, 인듀어런스 트레이닝 II, 어드밴스드 차지 마스터리, 콤비네이션 트레이닝 II\n하이퍼 스킬 : 맥시마이즈 캐논, 하이퍼 매그넘 펀치\n5차 : 벙커 버스터, 발칸 펀치, 버닝 브레이커, 애프터이미지 쇼크";
        break;
    case 23:
        rep = "배틀메이지\n\n1차 : 트리플 블로우, 텔레포트 Ver.2, 옐로우 오라, 데스, 아트 오브 스태프\n2차 : 쿼드 블로우, 다크 체인, 드레인 오라, 데스 컨트랙트\n3차 : 데스 블로우, 배틀 스퍼트, 블루 오라, 다크 라이트닝, 텔레포트 부스트, 배틀 마스터리, 너브 스티뮬레이션, 데스 컨트랙트2\n4차 : 피니쉬 블로우, 다크 제네시스, 다크 오라, 디버프 오라, 배틀 레이지, 쉘터, 스펠 부스트, 데스 컨트랙트3\n하이퍼 스킬 : 마스터 오브 데스, 배틀킹 바\n5차 : 유니온 오라, 블랙 매직 알터, 그림 리퍼, 어비셜 라이트닝";
        break;
    case 24:
        rep = "와일드헌터\n\n0차 : 포획, 헌터의 부름\n1차 : 더블 점프, 재규어 라이딩, 서먼 재규어, 클로우 컷, 프로보크, 오토매틱 슈팅 디바이스, 재규어 매니지먼트\n2차 : 크로스 로드, 소울 애로우 : 석궁, 하울링\n3차 : 소닉 붐, 화이트 히트 러쉬, 어시스턴트 헌팅 유닛, 비스트 폼, 드로우 백, 플러리, 재규어 링크\n4차 : 와일드 발칸, 와일드 발칸 Type-P, 재규어 소울, 드릴 컨테이너, 익스텐드 매거진, 와일드 인스팅트, 네이처 포스\n하이퍼 스킬 : 사일런트 램피지, 램피지 애즈 원, 플래쉬 레인\n5차 : 재규어 스톰, 재규어 맥시멈, 와일드 그레네이드, 와일드 발칸 Type X";
        break;
    case 25:
...
sk.getJobskilldesc3 = function(jobcode, skillcode){
    ...
    switch(jobcode){
        ...
        case 44:
            jobM = require('skillZero');
            rep = jobM.getskilldesc3Zero(skillcode);
            break;
        case 45:
            jobM = require('skillKinesis');
