...
ske.getskilldesc2Evan = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 6:
            ...
            break;
        case 7:
            rep = "공격시 15%확률로 최대MP의 5% 흡수, 보스몬스터에게는 3% 흡수";
            break;
        case 8:
...
ske.getskilldesc3Evan = function (skillcode){
    ...
    switch(skillcode){
        case 0:
            ...
            break;
        case 1:
            rep = "[미르 스킬] 미르가 강인한 드래곤의 육체를 이용한 여러 기술로 전방의 적을 유린한다. 드래곤 브레이크는 공격 반사 상태의 적을 공격해도 피해를 입지 않는다.\n미르 스킬과 융합 스킬은 공격 속도 증가의 효과를 받지 않는다.\n\nMP 1000 소비, 최대 12명의 적을 1265%의 데미지로 7번 공격, 2.5초 동안 지속\n\n재사용 대기시간 20초";
            break;
        case 2:
        ...
        case 44:
            ...
            break;
        case 45:
            rep = "미르에 탑승해 자유롭게 비행하며 강력한 브레스를 발사한다. 탑승한 상태에서 드래곤 마스터 스킬 키를 키다운 하여 브레스를 발사할 수 있다. 키다운 종료 시 바로 탑승이 해제된다.\n\nMP 10% 소비, 10초 동안 미르에 탑승, 탑승 중 무적\n0.3초 간격으로 10명의 적에게 450%의 데미지로 7번 공격\n스킬 종료 시 1초 무적, 남은 키다운 시간 1초 마다 재사용 대기시간 18초 감소, 최대 160초만큼 감소 가능\n\n재사용 대기시간 240초";
            break;
        case 24:
            rep = "";
            break;
