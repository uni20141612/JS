...
ske.getskilldesc2Evan = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 37:
            ...
            break;
        case 38:
            rep = "재사용 대기시간 중 마법 잔해의 데미지 20% 증가";
            break;
        case 39:
            rep = "개인 버프";
            break;
...
ske.getskilldesc3Evan = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 23:
            ...
            break;
        case 25:
            rep = "융합 스킬에 피격 당한 적의 주변에 마법 잔해를 생성한다. 생성된 마법 잔해를 발동시켜 에반 주변의 적에게 피해를 입힐 수 있으며 한번에 발동된 마법 잔해의 수가 많을수록 더 많은 피해를 입힐 수 있다.\n\n융합 스킬에 피격 당한 적 근처에서 마법 잔해 1개 생성, 재생성 대기시간 0.5초, 최대 생성 제한 15개\n발동 시 MP 100 소비, 최대 15명에게 분산되어 발사, 70%의 데미지로 1번 공격, 마법 잔해 5개당 데미지 40%p 증가, 생성된 마법 잔해는 사용하지 않고 일정 시간이 지나면 소멸";
            break;
        case 32:
