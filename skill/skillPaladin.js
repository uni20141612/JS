...
skp.getskilldesc3Paladin = function (skillcode){
    ...
    switch(skillcode){
        case 0:
            ...
            break;
        case 1:
            rep = "패시브 효과 : 엘리멘탈 차지가 충전될 때마다 30초 동안 팔라딘 주위를 회전하는 망치 1개 자동 생성, 최대 5개까지 생성 가능하나 홀리 차지와 유지시간 공유\n액티브 효과 : MP 1000 소비, 30초 동안 망치가 최대 8명의 적을 1155%의 데미지로 4번 자동 공격, 망치의 수가 늘어날 때마다 공격 속도 증가\n\n재사용 대기시간 60초";
            break;
        case 2:
