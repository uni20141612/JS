...
skh.getskilldesc1Hoyoung = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 6:
            ...
            break;
        case 7:
            rep = "[인 속성 도술] 최대 5명의 적을 70% 데미지로 5번 공격";
            break;
        case 8:
        ...
        case 10:
            ...
            break;
        case 11:
            rep = "[지 속성 도술] 최대 6명의 적을 80% 데미지로 4번 공격";
            break;
        case 12:
        ...
        case 17:
            ...
            break;
        case 18:
            rep = "[천 속성 도술] 최대 6명의 적을 140% 데미지로 5번 공격";
            break;
        case 19:
        ...
        case 21:
            ...
            break;
        case 22:
            rep = "[부적 도술] 부적 도력 100 소비, 40초 동안 도깨비불 소환";
            break;
        case 23:
            rep = "하단 참조";
            break;
...
skh.getskilldesc2Hoyoung = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 21:
            ...
            break;
        case 22:
            rep = "1.8초마다 적 추적후 최대 5명의 적을 200% 데미지로 5번 공격";
            break;
        case 23:
            rep = "[두루마리 도술]";
            break;
...
skh.getskilldesc3Hoyoung = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 38:
            ...
            break;
        case 39:
            rep = "분신을 사부님으로 둔갑시켜 귀에 못이 박히게 들었던 지겨운 잔소리를 재현한다. 사부님의 잔소리는 주위의 적을 행동 불가 상태로 만들며, 잔소리를 듣는 적이 적다면 더 집중적으로 잔소리를 해서 행동 불가 상태의 지속시간이 증가한다.\n\n최대 HP의 15% 소비, 분신이 범위 내 최대 HP가 높은 적에게 돌진해 최대 8명의 적을 800% 데미지로 8번 공격\n공격 당한 적은 8초 동안 행동 불가 상태, 공격 당한 적이 적다면 지속시간 최대 11초까지 증가\n해당 공격으로 적에게 준 데미지에 따라 행동 불가 지속시간 최대 100% 증가\n\n재사용 대기시간 : 200초";
            break;
    }
    return rep;
};
