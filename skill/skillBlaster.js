...
skb.getskilldesc3Blaster = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 3:
            ...
            break;
        case 4:
            rep = "건틀렛 리볼버의 폭발력을 이용하여 전방에 강력한 스트레이트 펀치를 내지른다. 해당 스킬을 사용하면서 리볼빙 캐논을 사용할 수 있다. 더블 팡과 버닝 브레이커로 연계가 가능하다.\n\nMP 12 소비, 최대 6명의 적을 100% 데미지로 3번 공격\n매그넘 펀치 사용 중 리볼빙 캐논을 사용하면 같은 수의 적을 60%의 데미지로 4번 추가 공격";
            break;
        case 5:
            rep = "건틀렛 리볼버에 내장된 캐논을 이용하여 추가 폭발을 일으켜 피해를 준다. 단독으로는 사용할 수 없으며 일부 공격 스킬 사용 시 자동으로 발동하거나 특정 공격 스킬 사용 중 수동으로 사용할 수 있다.\n키다운을 통해 차지 시 불릿을 수동으로 리로드한다. 차지는 다른 스킬 사용 중에도 가능하며 한 번에 최대 2개의 스킬을 동시에 차지할 수 있다.\n\n리볼빙 캐논 자동 발동 스킬 : 매그넘 펀치, 더블 팡\n리볼빙 캐논 수동 사용 가능 스킬 : 리볼빙 벙커\n\n불릿 1개 소비, 키다운 시 불릿 리로드";
            break;
        case 6:
