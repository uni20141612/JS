...
skh.getskilldesc3Hero = function (skillcode){
    ...
    switch(skillcode){
        case 0:
            ...
            break;
        case 1:
            rep = "콤보 카운터의 힘을 응축한 검으로 공간을 가른다.\n\nMP 500, 최대 15명의 적을 880%의 데미지로 14번 공격, 시전 동작 중 무적\n공격이 적중했다면 5초 동안 6개의 콤보 카운터가 증가시키는 최종 데미지와 같은 수치의 최종 데미지 증가, 콤보 카운터가 증가시키는 최종 데미지와 합 적용\n\n재사용 대기시간 20초";
            break;
        case 5:
