...
skcs.getskilldesc1Cannonshooter = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 11:
            ...
            break;
        case 12:
            rep = "180%, 10명, 3회 공격, 100%확률 60초간 초당 200%";
            break;
        case 13:
            rep = "하단 참조";
            break;
...
skcs.getskilldesc2Cannonshooter = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 11:
            ...
            break;
        case 12:
            rep = "해당 적에게 데미지 40% 증가, 재사용 대기시간 10초";
            break;
        case 13:
            rep = "랜덤 액티브 버프";
            break;
