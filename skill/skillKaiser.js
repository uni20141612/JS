...
skk.getskilldesc1Kaiser = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 44:
            ...
            break;
        case 45:
            rep = "MP 30 소비, 윌 오브 소드로 소환된 검 발사";
            break;
    }
    return rep;
};
...
skk.getskilldesc3Kaiser = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 9:
            ...
            break;
        case 16:
            rep = "일정 시간마다 사용하고 있는 검을 3개 소환한다. 윌 오브 소드 : 차지로 소환한 검을 움직여 주변의 몬스터를 추적하여 타격한다. 검은 최대 HP가 가장 높은 적을 우선하여 추적한다.\n스킬 사용 시 효과가 활성화되고 재사용 시 비활성화돠는 온오프 스킬\n\nMP 30 소비, 3초마다 장비중인 무기의 분신 3개 소환\n소환 후 윌 오브 소드 : 차지 사용 시 각각의 무기는 적에게 날아가 꽂히며 300%의 데미지로 3번 공격\n\n파이널 피규레이션 : 공격횟수 1회 증가";
            break;
        case 22:
