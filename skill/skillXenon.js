...
skx.getskilldesc1Xenon = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 29:
            ...
            break;
        case 30:
            rep = "60초간 볼이 몬스터에게 닿을 때마다 213% 데미지.";
            break;
        case 31:
            rep = "60초간 볼이 홀로그램 필드에 닿을 때마다 8명, 400% 데미지";
            break;
        case 32:
            rep = "60초간 파티원 최대 HP 10% 증가, 회피 시 에너지 1개 충전.";
            break;
        case 33:
            rep = "에너지 20 소비, 60초 동안 최종 데미지 30%";
            break;
        case 34:
            rep = "40% 확률로 추가 회피";
            break;
