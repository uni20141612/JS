...
sknw.getskilldesc1Nightwalker = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 20:
            ...
            break;
        case 21:
            rep = "340%의 데미지로 4번, 475%의 데미지로 1번 공격";
            break;
        case 22:
            rep = "하단 참조";
            break;
...
sknw.getskilldesc2Nightwalker = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 17:
            ...
            break;
        case 18:
            rep = "인벤토리 내 표창 중 가장 높은 공격력을 가진 표창의 공격력이 적용";
            break;
        case 19:
            rep = "스탠스 40% 증가";
            break;
...
sknw.getskilldesc3Nightwalker = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 2:
            ...
            break;
        case 3:
            rep = "매우 빠른 속도로 표창을 수없이 던진다. 공중에서 사용 시 체공하며 던지며 래피드 스로우는 다크 사이트 중 사용해도 다크 사이트가 해제되지 않는다. 래피드 스로우에는 쉐도우 모멘텀 관성 효과가 적용되지 않는다. 각 표창은 쉐도우 배트 및 래버너스 배트의 표창 스킬 횟수에 최대 1회 반영된다. 어둠 속성의 공격이지만 연속 투척 공격에는 쉐도우 스피어에 의한 그림자 조각이 생성되지 않는 대신 더 높은 데미지를 준다.\n\nMP 1000 소비, 최대 8명의 적을 1045%의 데미지로 5번 공격하는 그림자 표창을 1.8초 동안 연속 투척한 후 최대 10명의 적을 1870%의 데미지로 13번 공격하는 거대 그림자 표창으로 마무리\n사용 중 스킬을 연타하여 연속 투척 시간을 최대 3초까지 증가시킬 수 있음\n쉐도우 스피어 발동 중 연속 투척 공격의 데미지 290%p 증가\n\n재사용 대기시간 90초";
            break;
        case 4:
