...
skar.getskilldesc3Aran = function (skillcode){
    ...
    switch(skillcode){   
        ...
        case 18:
            ...
            break;
        case 25:
            rep = "마하와 함께 아란의 힘을 최대로 이끌어내어 전방의 적을 휩쓴다. 파이널 블로우를 사용한 후 연계로 사용 시 데미지가 증가하며 시전하는 동안에는 적의 어떠한 공격에도 밀려나지 않는다.\n아드레날린 부스트 추가효과 : 전후방에 에너지 파동 발사\n\nMP 40 소비, 최대 6명의 적에게 295% 데미지로 5번 공격, 이후 스킬키 연타를 통한 추가 조작으로 최대 3타까지 공격 가능\n2타 : 311% 데미지로 5번 공격\n3타 : 326% 데미지로 5번 공격\n추가 크리티컬 확률 100%, 몬스터 방어율 30% 추가 무시, 일반 몬스터 공격 시 데미지 8% 추가 증가\n파이널 블로우와 연계하여 사용 시 데미지 20%p 증가\n아드레날린 부스트 상태 시 최대 6명의 적을 400% 데미지로 5번 공격하는 파동 방출";
            break;
        case 33:
            ...
            break;
        case 34:
            rep = "폴암 마하의 힘이 깃들어 강력한 힘을 발휘한다.\n\nMP 1000 소비, 사용 즉시 160콤보 증가, 40초 동안 마하의 힘이 깃들어 공격력 35% 증가, 공격 스킬 사용 시 3초마다 최대 10명의 적을 990%의 데미지로 5번 공격하는 눈보라 발생\n\n재사용 대기시간 : 90초";
            break;
        case 36:
            rep = "폴암을 크게 휘둘러 신화 속 늑대의 일격을 재현한다. 비욘더 3타를 사용한 후 비욘더를 다시 사용하여 사용할 수 있으며 시전하는 동안에는 적의 어떠한 공격에도 밀려나지 않는다.\n아드레날린 부스트 추가효과 : 전방으로 빙산 생성\n\nMP 200 소비, 최대 10명의 적에게 735%의 데미지로 7번 공격\n추가 크리티컬 확률 100%, 몬스터 방어율 50% 추가 무시\n아드레날린 부스트 상태 시 최대 10명의 적을 650%의 데미지로 6번 공격하는 빙산 생성\n\n비욘더 3타를 사용한 이후에 사용 가능";
            break;
        case 37:
...
skar.getskillimage1Aran = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 24:
            ...
            break;
        case 25:
            rep = "https://i.imgur.com/SgZWLoN.png";
            break;
        case 26:
