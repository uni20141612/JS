...
skab.getskilldesc3Angelicbuster = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 12:
            ...
            break;
        case 18:
            rep = "에스카다의 힘을 응축하여 한 명의 적을 연속적으로 휩쓴다. 추가로 데미지와 방어율 무시가 증가한다.\n\n최대 3명의 적을 630% 데미지로 6번 공격, 적중 시 트리니티와 트리니티 퓨전의 데미지 및 방어율 무시 15% 증가 버프가 최대 2회 중첩. 소울 리차지 스킬. 리차지 성공 확률 50%.\n\n[패시브 효과 : 최종 데미지 25% 증가, 방어율 무시 15% 증가]";
            break;
        case 19:
            rep = "사랑과 정의의 힘이 담긴 리본을 휘둘러 주변의 모든 적을 휘몰아친다.\n\n10명의 적에게 400% 데미지로 10번 공격. 공격 당한 적에게 60초 동안 엔젤릭버스터의 최종 데미지 25%, 다른 직업 파티원의 데미지 20% 증가하는 디버프 발생\n재사용 대기시간 40초. 리차지 성공 확률 50%";
            break;
        case 20:
...
skab.getskillimage1Angelicbuster = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 17:
            ...
            break;
        case 18:
            rep = "https://i.imgur.com/Spevn2v.png";
            break;
        case 19:
...
skab.getskillimage2Angelicbuster = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 17:
            ...
            break;
        case 18:
            rep = "https://i.imgur.com/5dF4tSo.png";
            break;
        case 19:
