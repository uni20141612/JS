...
skpf.getskilldesc1Pathfinder = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 15:
            ...
            break;
        case 16:
            rep = "[카디널 포스] 최대 5명의 적을 200%의 데미지로 4번 공격";
            break;
        case 17:
            rep = "하단 참조";
            break;
        ...
        case 19:
            ...
            break;
        case 20:
            rep = "[카디널 포스] 최대 6명의 적을 420%의 데미지로 4번 공격";
            break;
        case 21:
            rep = "하단 참조";
            break;
        ...
        case 30:
            ...
            break;
        case 31:
            rep = "게이지 100, 최대 8명의 적을 880%의 데미지로 6번 공격";
            break;
        case 32:
            rep = "하단 참조";
            break;
...
skpf.getskilldesc3Pathfinder = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 21:
            ...
            break;
        case 22:
            rep = "순간적으로 위로 도약한 뒤, 폭발 화살을 하단으로 3발 발사한다. 발사된 화살은 적에게 닿거나 최대 사정거리에 도달하면 폭발한다.\n이미 공중에 있는 상태라면 도약 없이 바로 화살을 발사한다.\n추가로 스플릿 미스텔의 일반 몬스터 공격 시 데미지를 영구적으로 증가시킨다.\n\n렐릭 게이지 50 소비, 화살 폭발 시 최대 4명의 적을 265%의 데미지로 5번 공격\n재사용 대기시간 10초\n\n[패시브 효과 : 스플릿 미스텔의 일반 몬스터 공격 시 데미지 120p 증가]";
            break;
        case 24:
        ...
        case 32:
            ...
            break;
        case 33:
            rep = "활대로 가까운 적을 공격 후 공간을 날아다니는 화살을 쏘아 넓은 범위의 적들을 공격한다.\n화살이 더 넓은 범위의 적들을 공격한다.\n\n렐릭 게이지 100 소비, 활대 공격은 최대 5명의 적을 600%의 데미지로 7번 공격, 피격 당한 적은 고대의 저주 디버프 1개 중첩\n화살 공격은 최대 12명의 적을 650%의 데미지로 5번 공격\n\n재사용 대기시간 20초";
            break;
        case 34:
            rep = "활대로 가까운 적을 공격 후 공간을 날아다니는 화살을 쏘아 넓은 범위의 적들을 공격한다.\n활대에 힘을 실어 더욱 강력한 일격을 가한다.\n\n렐릭 게이지 100 소비, 활대 공격은 최대 1명의 적을 600%의 데미지로 8번 공격, 피격 당한 적은 고대의 저주 디버프 1개 중첩\n화살 공격은 최대 10명의 적을 600%의 데미지로 5번 공격\n\n재사용 대기시간 20초";
            break;
        case 35:
            rep = "활대로 가까운 적을 공격 후 공간을 날아다니는 화살을 쏘아 넓은 범위의 적들을 공격한다.\n활대에 저주의 힘을 집중하여 피격당한 적에게 치명적인 저주를 전이시킨다.\n\n렐릭 게이지 100 소비, 활대 공격은 최대 4명의 적을 600%의 데미지로 7번 공격, 피격 당한 적은 고대의 저주 디버프 5개 중첩\n화살 공격은 최대 10명의 적을 650%의 데미지로 5번 공격\n\n재사용 대기시간 20초";
            break;
        case 36:
            rep = "렐릭에 저장된 트랜지션의 힘을 확장한다. 디스차지, 블래스트의 카디널 및 인챈트 스킬로도 저주의 기운을 실어 화살을 발사할 수 있게 되며, 영구히 공격력이 증가한다.\n\n디스차지, 블래스트 문양의 카디널 포스 스킬 및 인챈트 포스 스킬로 적 공격 시 40% 확률로 고대의 저주 디버프 1개 중첩\n영구히 공격력 20% 증가";
            break;
        case 37:
            rep = "고대의 궁술을 수련하여 전투 능력을 강화한다.\n\n에디셔널 디스차지 데미지 65%p 증가, 에디셔널 블래스트 데미지 70%p 증가\n스플릿 미스텔 최초 화살 데미지 350%p 증가, 추가 마법 화살 데미지 200%p 증가\n에인션트 포스/인챈트 포스 스킬의 최종 데미지 10% 증가, 보스 몬스터 공격 시 데미지 50% 증가";
            break;
        case 38:
