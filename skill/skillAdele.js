...
ska.getskilldesc3Adele = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 29:
            ...
            break;
        case 29:
            rep = "허공에 존재하는 작은 조각에 마력을 불어넣어 자라게 한 후 파쇄한다. 파쇄된 위치에는 마력이 집중되어 에테르 결정이 생성되며 재생성 대기시간을 무시한다.\n\nMP 250 소비, 최대 7명의 적 위치에 조각 생성\n조각은 생성 및 파쇄될 때 각각 최대 7명의 적을 500%의 데미지로 6번 공격\n모든 조각을 통틀어 공격한 적이 1명이라면 마커의 최종 데미지 300% 증가\n공격할 수 있는 적이 최대 공격 가능한 적의 수보다 적다면 임의의 위치에 조각 5개까지 생성\n조각이 파쇄된 후 에테르 결정 최대 5개까지 생성\n\n재사용 대기시간 60초";
            break;
        case 9:
            rep = "";
            break;
