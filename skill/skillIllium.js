...
ski.getskilldesc3Illium = function (skillcode){
    ...
    switch(skillcode){
        case 0:
            rep = "모든 것을 불태우는 강력한 에너지 기운을 전방으로 내뿜는다. 키다운 사용 도중 좌, 우로 이동할 수 있다. 공격 적중 시 블레스 마크의 지속시간이 갱신된다.\n\n공격당 MP 30 소비, 최대 6초 동안 키다운을 유지하며 일정 간격으로 최대 15명의 적을 2566%의 데미지로 5번 공격, 보스 몬스터 공격 시 데미지 20% 증가\n\n재사용 대기시간 180초";
            break;
        case 1:
        ...
        case 27:
            ...
            break;
        case 31:
            rep = "크래프트:자벨린을 강화시킨다. 크래프트:자벨린이 적에게 명중하면 작은 파편으로 갈라져 추가 공격한다.\n크래프트:오브와 연계하여 사용 가능하고 다수 공격 스킬의 공격 대상 증가 효과를 받지 않는다. 자벨린과 매직 미사일은 최대 HP가 높은 보스 몬스터를 우선 추적한다.\n\nMP 소비량 6, 최대 공격 가능한 몬스터 수 1명, 데미지 95%p, 공격 횟수 1번 증가\n명중 시 130%의 데미지를 입히는 파편 2개 생성, 글로리 윙:자벨린을 사용했을 때는 파편 대신 적을 추적하여 250%의 데미지로 3번 공격하는 매직 미사일 3개 생성\n\n[패시브 효과 : 글로리 윙:자벨린의 데미지 200%p 증가]";
            break;
        case 34:
