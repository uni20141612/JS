...
skew.getskilldesc3Eunwol = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 13:
            ...
            break;
        case 22:
            rep = "땅의 정령을 강령시켜, 전방에 있는 다수의 적을 공격한다. 스킬을 연속으로 사용하여 최대 3타까지 연속 공격이 가능하다.\n\n1타당 MP 20 소비\n[1타]: 최대 8명의 적을 300%의 데미지로 3번 공격\n[2타]: 최대 8명의 적을 300%의 데미지로 3번 공격\n[3타]: 최대 8명의 적을 300%의 데미지로 3번 공격, 공격 당한 적은 100% 확률로 2초 동안 기절\n\n모든 공격이 일반 몬스터 공격 시 85% 데미지 증가";
            break;
        case 24:
