...
skdb.getskilldesc1Dualblades = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 16:
            ...
            break;
        case 17:
            rep = "최대 8명의 적을 250% 데미지로 5번 공격";
            break;
        case 18:
            rep = "330% 데미지로 3명의 적 6번 공격";
            break;
        case 19:
            rep = "하단 참조";
            break;
