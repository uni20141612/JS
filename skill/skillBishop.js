...
skb.getskilldesc1Bishop = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 12:
            ...
            break;
        case 13:
            rep = "5회 치명적인 상태 이상 저항. 재사용 대기시간 80초";
            break;
        case 14:
        ...
        case 22:
            ...
            break;
        case 23:
            rep = "최대 15명의 적에게 324% 데미지로 10번 공격";
            break;
        case 24:
...
skb.getskilldesc2Bishop = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 11:
            ...
            break;
        case 12:
            rep = "일정 시간마다 최대 8명의 적을 180%의 데미지로 5번 공격";
            break;
        case 13:
        ...
        case 22:
            ...
            break;
        case 23:
            rep = "추가 크리티컬 확률 20%, 재사용 대기시간 30초";
            break;
        case 24:
            rep = "일몹뎀 50% 증가 / 점샷 가능";
            break;
...
skb.getskilldesc3Bishop = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 2:
            ...
            break;
        case 3:
            rep = "사악한 자들에게 신의 이름으로 징벌을 내린다. 징벌을 당한 적에게 엔젤레이와 동일한 최종 데미지 증가 디버프를 부여한다.\n\n공격당 MP 40 소비, 초당 성스러운 빛 1개 소비\n전방 6명의 적에게 535%의 데미지로 10번 연속 공격\n성스러운 빛은 8.5초마다 1개씩 준비되며 최대 8개까지 소지 가능\n\n재사용 대기시간 : 1.5초";
            break;
        case 5:
        ...
        case 15:
            ...
            break;
        case 16:
            rep = "[복수] 승리의 천사의 힘을 강림시킨다. 승리의 힘이 지속 중일 때 스킬 적중 시 천사의 날개 깃털이 생성되어 주변의 적을 추적하여 공격한다.\n\nMP 150 소비, 120초 동안 지속, 자신이 직접 공격하는 스킬 적중 시 4초 동안 적을 찾아 230%의 데미지로 4번 공격하는 천사의 날개 깃털 4개 생성\n날개 깃털 재생성 대기시간 3초\n\n재사용 대기시간 60초";
            break;
        case 20:
            rep = "스킬 사용 시 자신을 포함한 파티원의 HP를 일정 비율 회복시켜주며 일정 시간 동안 모든 피해를 방어하는 성스러운 보호막을 걸어준다. 보호막은 일정 시간 동안 유지되나 버프 지속시간 증가의 효과를 받지 않는다. 한 번 발동되면 홀리 매직쉘을 다시 사용해도 일정 시간 동안 재생성되지 않는다.\n\nMP 70 소비, 최대 HP의 50% 회복, 15초 동안 마법의 보호막 생성. 보호막이 유지되는 동안 최대 15번의 피해를 방어\n최대 HP의 일정 비율로 피해를 입히는 공격에 피격 시 10% 피해 감소\n\n발동 시 80초 동안 보호막 재생성 및 홀리 매직쉘으로 회복 불가. 재사용 대기시간 90초";
            break;
        case 22:
