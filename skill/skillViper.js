...
skv.getskilldesc1Viper = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 7:
            ...
            break;
        case 8:
            rep = "[수룡 스킬] 111% 데미지로 최대 6명의 적 4번 공격";
            break;
        case 9:
            rep = "하단 참조";
            break;
        ...
        case 20:
            ...
            break;
        case 21:
            rep = "[격투 스킬] 7명의 적을 565%의 데미지로 4번 공격";
            break;
        case 22:
            rep = "씨 서펜트 버스트를 씨 서펜트 버스트 II로 강화";
            break;
        case 23:
            rep = "[수룡 스킬] 425% 데미지로 최대 8명의 적 8번 공격";
            break;
        case 24:
            rep = "하단 참조";
            break;
        ...
        case 26:
            ...
            break;
        case 27:
            rep = "180초 동안 공격력 15% 증가/ [패시브: 숙련도 70%,";
            break;
        case 28:
            rep = "하단 참조";
            break;
...
skv.getskilldesc2Viper = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 26:
            ...
            break;
        case 27:
            rep = "최종데미지 13%, 상태 이상 30, 내성 30% 증가]";
            break;
        case 28:
...
skv.getskilldesc3Viper = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 30:
            ...
            break;
        case 31:
            rep = "수룡의 힘을 사용했을 때 수룡의 가호로 일정 시간 동안 피격 시 받는 피해를 감소시킨다.\n\n수룡 스킬, 어썰트 스킬 적중 시 3초 동안 최대 HP의 일정 비율로 피해를 입히는 공격을 포함하여 피격 데미지 30% 감소시키는 보호막 생성\n\n발동 시 4초 동안 보호막 재생성 불가";
            break;
        case 34:
