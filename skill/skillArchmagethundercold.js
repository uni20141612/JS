...
sktc.getskilldesc3Archmagethundercold = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 21:
            ...
            break;
        case 24:
            rep = "파티원을 깨지지 않는 냉기로 감싸는 오라를 발생시킨다. 아래 방향키와 함께 재사용 시 냉기가 빠르게 휘몰아치는 소용돌이를 생성한다. 소용돌이 내부의 적은 더 빠르게 빙결된다.\n\n초당 MP 60 소비, 자신을 포함한 주위 파티원에게 상태 이상 내성 20, 모든 속성 내성 20% 증가\n피격 데미지 20% 감소\n일정 주기마다 최대 15명의 적에게 빙결을 중첩시킴\n\n소용돌이 : 30초 동안 지속, 소용돌이 내에 있는 아군에게 아이스 오라와 같은 효과를 적용시키며 적은 더 빠르게 빙결시킴\n소용돌이 생성 재사용 대기시간 60초";
            break;
        case 25:
