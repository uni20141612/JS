...
skc.getskilldesc1Cadena = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 6:
            ...
            break;
        case 7:
            rep = "125%의 데미지로 최대 6명의 적을 5번 공격 / 슈스탠";
            break;
        case 8:
            rep = "점프 중 사용하면 진행 방향으로 연속 두 번 점프한다";
            break;
        case 9:
            rep = "이속40, 점프력20, 회피율 15% 증가";
            break;
        case 10:
            rep = "영구적으로 행운 50 증가";
            break;
        case 11:
            ...
            break;
        case 12:
            rep = "235%의 데미지로 최대 10명의 적을 4번 공격 / 슈스탠";
            break;
        case 13:
            rep = "하단 참조";
            break;
        ...
        case 24:
            ...
            break;
        case 25:
            rep = "535%의 데미지로 최대 7명의 적을 7번 공격 / 슈스탠";
            break;
        case 26:
            rep = "하단 참조";
            break;
...
skc.getskilldesc3Cadena = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 6:
            ...
            break;
        case 13:
            rep = "일정 시간 후 폭발하는 수리검을 소환하여 지면에 낮게 깔아 던진다. 수리검은 적을 밀어내며 공격한다. 공격 반사 상태의 적을 공격해도 피해를 입지 않고 일부 몬스터는 저항하여 밀리지 않는다. 사용 및 폭발 시 다크 사이트를 해제하지 않는다.\n\nMP 28 소비, 7초 동안 205%의 데미지로 총 40번 공격, 공격 횟수를 모두 채우거나 일정 시간이 지난 경우 자동 폭발하며, 폭발 시 450%의 데미지로 최대 8명의 적을 3번 공격,\n스킬키를 재입력하여 수동 폭발 가능.\n\n재사용 대기시간 : 10초";
            break;
        case 14:
            ...
            break;
        case 17:
            rep = "샷건을 소환하여 전방 부채꼴 범위의 적에게 산탄을 발사한다. 가까운 적일수록 큰 피해를 입는다. 발사 시의 역추진력을 이용해 후방으로 뛰어오르며 이동한다. 시전 동작 중 어떠한 공격에도 밀리지 않는다.\n\nMP 30 소비, 최대 6명의 적을 7번 공격\n가까운 거리 : 390%의 데미지\n중간 거리 : 320%의 데미지\n먼 거리 : 275%의 데미지\n\n재사용 대기시간 : 5초";
            break;
        case 18:
        ...
        case 20:
            ...
            break;
        case 26:
            rep = "가시 박힌 방망이를 소환하여 머리 위로 가차 없이 내리꽂는다. 3번 연속해서 사용할 수 있으며 방향키와 함께 사용하면 앞으로 전진하며 사용한다. 연속 사용 중 공격 스킬을 사용하면 다음 타수를 사용할 수 없다. 니들배트에 맞은 적은 일정 시간 동안 혼미 상태 이상에 걸린다. 시전 동작 중 어떠한 공격에도 밀리지 않는다.\n\nMP 40 소비,\n1타 : 495%의 데미지로 최대 8명의 적을 8번 공격\n2타 : 640%의 데미지로 최대 8명의 적을 9번 공격\n3타 : 915%의 데미지로 최대 10명의 적을 10번 공격\n공격 시 100% 확률로 30초 동안 혼미 상태 이상 효과가 적용되어 적의 공격력 20% 감소\n\n재사용 대기시간 : 12초";
            break;
        case 27:
            rep = "체인을 길게 뽑아 주변에 무한대를 그리며 사정없이 휘두른다. 사용 직후 짧은 시간 동안 체인을 극한으로 휘둘러 어떠한 피해도 입지 않는다. 주변의 적은 체인 채찍이 만들어내는 소용돌이에 빨려 들어와 산산이 부서진다. 공격 적중 시 웨폰 버라이어티의 스택 중첩이 최대치로 고정된다. 터프 허슬은 재사용 대기시간 초기화의 효과에 영향을 받지 않는다.\n\n공격당 MP 25 소비, 시전 후 2초 동안 무적\n600%의 데미지로 최대 12명의 적을 2번 공격, 최대 6초 동안 지속\n키다운 중에 이동키로 이동 가능\n\n재사용 대기시간 : 45초";
            break;
        case 28:
            rep = "체인을 순식간에 길게 뽑아 휘둘러 범위 내의 적을 체인으로 결박한다. 체인아츠:테이크다운은 최대 HP가 높은 적을 우선 결박한다.\n결박 후 일정 시간이 지나면 잔상이 남을 정도로 빠르게 적을 난타한다. 난타의 위력은 해당 시간 동안 발동된 웨폰 버라이어티 추가타의 횟수에 따라 달라지고, 난타 중에는 웨폰 버라이어티 중첩이 최대치로 유지된다.\n재사용 대기시간 초기화의 효과를 받지 않고 공격을 받은 적은 90초 동안 행동 불가 상태 이상에 저항하여 체인아츠:테이크다운 및 다른 스킬로 인한 행동 불가 상태 이상에 걸리지 않는다.\n\nMP 255 소비, 최대 8명의 적을 300%의 데미지로 2번 공격하며 10초 동안 행동 불가 상태로 만듦, 해당 공격으로 적에게 준 데미지에 따라 행동 불가 지속시간 최대 100% 증가\n시전 후 5초 동안 웨폰 버라이어티 추가타 발동 횟수에 따라 공격 강도가 3단계로 나뉘는 난타 발생, 발동 횟수를 시간 내에 충족하지 않으면 최소 단계의 난타 발생\n난타 : 웨폰 버라이어티 발동 횟수가 0, 3, 5회 이상일 때 단계에 따라 묶은 위치에서 770%/880%/990%의 데미지로 15번 공격 후 최대 10명의 적을 250%/350%/500%의 데미지로 10번 공격하는 마무리 발동\n연속 공격 중 타격에 따라 최대 10명의 적을 600%의 데미지로 4번 공격하는 충격파 발생, 모든 공격은 방어율 80% 추가 무시\n\n재사용 대기시간 : 120초";
            break;
        case 29:
            rep = "무기 간의 흐름을 완전히 깨우쳐 웨폰 버라이어티의 효과를 완성시킨다. 추가타 발동 시 일정 시간 동안 다크 사이트 상태가 되며 빠르게 소멸하는 보호막 효과가 발동된다. 웨폰 버라이어티 Ⅱ의 증가량을 덮어쓴다. 단, 소환 무기 사용 스킬의 데미지 증가 패시브 효과는 덮어쓰지 않고 중첩된다.\n\n무기 교체 시 30초 동안 버프 1 스택당 모든 공격 스킬의 최종 데미지 10% 증가, 체인아츠를 제외한 사용 가능 소환 무기 스킬 최대 개수만큼 중첩 가능\n버프 중첩 및 갱신 시 350%의 데미지로 최대 7명의 적을 4번 공격하는 추가타 발생\n추가타 발생 시 2초 동안 다크 사이트 및 최대 HP의 7%의 피해를 막아주는 보호막 생성\n\n보호막은 최대 HP의 25%만큼 누적 가능하며 초당 현재 보호막의 30% + 50씩 소멸\n추가타 재발동 대기시간 : 0.25초\n\n[패시브 효과 : 커팅 시미터, 스크래칭 클로, 스로잉 윙대거, 슈팅 샷건, 슬래싱 나이프, 릴리싱 봄 데미지 170%p 증가]";
            break;
        case 30:
            rep = "상태 이상에 걸린 적에 대해 연구를 통해 더 치명적인 집중 공격을 가한다. 상태 이상에 빠진 적을 공격 시 일정 확률로 출혈 상태 이상을 건다. 위크포인트 어택의 증가량을 덮어쓴다.\n\n일반 몬스터 공격 시 데미지 10% 증가\n상태 이상에 걸린 적 공격 시 크리티컬 확률 2%, 크리티컬 데미지 10% 증가, 상태 이상 최대 10개까지 적용\n50% 확률로 30초 동안 1초당 110% 데미지의 출혈 상태 이상을 걺";
            break;
        case 32:
