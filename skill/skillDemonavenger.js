...
skda.getskilldesc3Demonavenger = function (skillcode){
    ...
    switch(skillcode){
        case 0:
            rep = "끝없는 복수심에 자신의 몸을 태워 힘을 얻는다. 마족의 피로 공격 반사 및 공격 무시 상태의 적에게도 피해를 줄 수 있다.\n\n최대 HP의 20% 소비, 초당 HP 6000 소비, 회복 아이템 및 스킬의 회복량 최대 HP의 2%까지로 제한, 최대 HP의 일정 비율로 피해를 입히는 공격을 포함한 피격 데미지 30% 감소\n최대 HP 대비 소모된 HP 2%당 최종 데미지 1% 증가하여 최대 20%까지 증가, 복수심에 타오르는 마족의 피가 주위를 맴돌며 최대 10명의 적을 일정 주기마다 840%로 3번 공격\n최대 HP의 30% 이하에서는 데몬 프렌지로 HP를 소모하지 않고 회복량 제한도 받지 않음\n재사용 시 스킬 비활성화\n\n재사용 대기시간 1초";
            break;
        case 1:
