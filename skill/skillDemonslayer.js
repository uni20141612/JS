...
skds.getskilldesc1Demonslayer = function (skillcode){
    ...
    switch(skillcode){
        ...
        case 30:
            ...
            break;
        case 31:
            rep = "포스 100 / 35초간 포스 제한없이 스킬 사용 가능";
            break;
        case 32:
...
skds.getskilldesc3Demonslayer = function (skillcode){
    ...
    switch(skillcode){
        case 0:
            ...
            break;
        case 1:
            rep = "포스를 제물로 명계의 마룡을 소환한다. 마룡의 공격은 공격 반사 상태의 적을 공격해도 피해를 입지 않는다.\n\n포스 30 소비, 55초 동안 소환\n네메아 : 2초마다 최대 10명의 적을 880%의 데미지로 12번 공격, 공격 시 포스 추가 흡수량 8\n게리온 : 3초마다 최대 10명의 적을 1980%의 데미지로 10번 공격, 공격 시 포스 추가 흡수량 12\n오르트로스의 모든 공격은 추가 크리티컬 확률 100%, 몬스터 방어율 50% 추가 무시\n\n재사용 대기시간 120초";
            break;
        case 2:
            ...
            break;
        case 3:
            rep = "강대한 포스를 분출하여 무적 상태가 되어 적들을 파멸시킨다.\n데몬 어웨이크닝 지속 중 사용 시 각성 상태의 포스를 분출하여 위력이 증가한다.\n키다운 종료 시 포스에 휩싸여 더욱 강력한 공격을 할 수 있다.\n마지막 공격 중 아래 방향키와 함께 스킬을 재사용하여 즉시 종료할 수 있다.\n\n포스 60, HP 2000 소비, 6.0초 동안 무적\n데몬 어웨이크닝 지속 중 사용 시 데몬 베인의 최종 데미지 90% 증가\n키다운 동안 최대 5명의 적을 580%의 데미지로 6번 연속 공격, 최대 키다운 시간 3초\n키다운 종료 시 최대 12명의 적을 1375%의 데미지로 7번 연속 공격, 키다운 지속 시간에 비례해 공격시간 2배까지 증가\n모든 공격은 추가 크리티컬 확률 50%, 몬스터 방어율 30% 추가 무시\n\n재사용 대기시간 : 120초";
            break;
        case 4:
