...
gB.getBossHP = function (ind){
    ...
    switch(ind){
      ...
      case 42:
        ...
        break;
      case 43:
        rep = "50조ㆍ54조ㆍ12.8조 / 131,095,655메소";  //하드 루시드
        break;
      case 44:
      ...
      case 45:
        ...
        break;
      case 46:
        rep = "90조 / 155,492,141메소"; //카오스 가디언 엔젤 슬라임
        break;
      case 47:
      ...
      case 49:
        ...
        break;
      case 50:
        rep = "63조ㆍ180조 / 196,904,752메소"; //노멀 선택받은 세렌
        break;
      case 51:
        rep = "126조ㆍ360조 / 267,825,621메소"; //선택받은 세렌
        break;
      case 52:
        rep = "63조ㆍ115.5조ㆍ157.5조ㆍ140조 / 1,418,809,857메소";  //검은 마법사
        break;
      case 53:
        rep = "336조ㆍ720조 / 300,000,000메소"; //노멀 감시자 칼로스
        break;
      case 54:
      ...
      case 60:
        ...
        break;
      case 61:
        rep = "각 400조ㆍ500조ㆍ각 500조 / 350,000,000메소"; //노멀 카링
        break;
      case 62:
        rep = "94.4조ㆍ262.4조"; //이지 감시자 칼로스
        break;
      case 63:
        rep = "1250조ㆍ4800조"; //카오스 감시자 칼로스
        break;
      case 64:
        rep = "6720조ㆍ1경 4400조"; //익스트림 감시자 칼로스
        break;
      case 65:
        rep = "1489조ㆍ5800조"; //익스트림 선택받은 세렌
        break;
      case 66:
        rep = "각 96조ㆍ100조ㆍ각 120조"; //이지 카링
        break;
      case 67:
        rep = "각 ?조ㆍ?조ㆍ각 ?조"; //하드 카링
        break;
      case 68:
        rep = "각 ?경 ?조ㆍ?경 ?조ㆍ각 ?경 ?조"; //익스트림 카링
        break;
      case 69:
        rep = "1260조ㆍ1470조ㆍ1575조ㆍ1680조"; //익스트림 검은 마법사
        break;
...
gB.getBossinfo = function (ind){
    ...
    switch(ind){
        ...
        case 33:
          ...
          break;
        case 34:
          rep = "300%, 반감, 상시 피해감소 15%, 수에큐 3개";  //노멀 가디언 엔젤 슬라임
          break;
        case 35:
        ...
        case 45:
          ...
          break;
        case 46:
          rep = "300%, 반감, 상시 피해감소 15%, 수에큐 10개"; //카오스 가디언 엔젤 슬라임
          break;
        case 47:
        ...
        case 60:
          ...
          break;
        case 61:
          rep = "380%, 반감, 바인드 면역, 어센틱포스 330"; //노멀 카링
          break;
        case 62:
          rep = "380%, 반감, 어센틱포스 200"; //이지 감시자 칼로스
          break;
        case 63:
          rep = "380%, 반감, 어센틱포스 330"; //카오스 감시자 칼로스
          break;
        case 64:
          rep = "380%, 반감, 어센틱포스 440"; //익스트림 감시자 칼로스
          break;
        case 65:
          rep = "380%, 반감, 어센틱포스 150ㆍ200"; //익스트림 선택받은 세렌
          break;
        case 66:
          rep = "380%, 반감, 바인드 면역, 어센틱포스 330"; //이지 카링
          break;
        case 67:
          rep = "380%, 반감, 바인드 면역, 어센틱포스 350"; //하드 카링
          break;
        case 68:
          rep = "380%, 반감, 바인드 면역, 어센틱포스 480"; //익스트림 카링
          break;
        case 69:
          rep = "300%, 반감, 포스 1320"; //익스트림 검은 마법사
          break;
    }
    return rep; 
  };
...
var bossList = [
    ...
    "노멀 감시자 칼로스 Lv.275/Lv.280\n336조ㆍ720조, 반감, 포스 250ㆍ300\n300,000,000메소",  //53
    "피아누스 Lv.110\n좌 : 2400만, 비반감\n우 : 3000만, 비반감", //54
    "불꽃늑대 Lv.1\n6000억, 90%, 반감", //55
    "도로시 Lv.210\n8400억, 250%, 비반감", //56
    ...
    "노멀 카링 Lv.285\n각 400조ㆍ500조ㆍ각 500조, 380%\n 포스 330, 반감, 바인드 면역\n350,000,000메소",//61
    "이지 감시자 칼로스 Lv.270\n94.4조ㆍ262.4조, 반감, 포스 200\n230,000,000메소",//62
    "카오스 감시자 칼로스 Lv.285\n1250조ㆍ4800조, 반감, 포스 330\n600,000,000메소",//63
    "익스트림 감시자 칼로스 Lv.285\n6720조ㆍ1경 4400조, 반감, 포스 440\n1,200,000,000메소",//64
    "익스트림 선택받은 세렌 Lv.270ㆍLv.280\n1489조ㆍ5800조\n380%, 반감, 포스 150ㆍ200\n1,071,303,484메소",//65
    "이지 카링 Lv.285\n각 96조ㆍ100조ㆍ각 120조, 380%\n 포스 330, 반감, 바인드 면역\n250,000,000메소",//66
    "하드 카링 Lv.285\n각 ?조ㆍ??조ㆍ각 ??조, 380%\n 포스 350, 반감, 바인드 면역\n700,000,000메소",//67
    "익스트림 카링 Lv.285\n각 ?경 ?조ㆍ?경 ?조ㆍ각 ?경 ?조, 380%\n 포스 480, 반감, 바인드 면역\n1,400,000,000메소",//68
    "익스트림 검은 마법사 Lv.275\n1260조ㆍ1470조ㆍ1575조ㆍ1680조\n300%, 반감, 포스 1320\n5,675,239,428메소", //69
];
