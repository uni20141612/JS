...
gt.getexpInform = function (msg){
  ...
  if(startlv == undefined){
    ...
    if(startlv >= endlv){
      ...
      var endexp = cumulate(exps, endlv-2);
      var startexp = cumulate(exps, startlv-2);
      //var remain = accexps[endlv - 1] - accexps[startlv - 1];
      var remain = endexp - startexp;
...
function cumulate(arrs, ind) {
    var ret = 0;
    var inds = parseInt(ind)
    for(i = 0; i < inds+1; ++i){
      ret += arrs[i];
    }
    return ret;
...
gt.levarcane = "레벨별 아케인포스 증감표\n\n(포스비율) (주는 피해) (받는 피해)\n\n0%\t10%\t280%\n1~29%\t30%\t240%\n30~49%\t60%\t180%\n50~69%\t70%\t160%\n70~99%\t80%\t140%\n100%~109%\t100%\t100%\n110%~129%\t110%\t80%\n130%~149%\t130%\t40%\n150%~\t150%\t0%";
gt.levauthentic = "레벨별 어센틱포스 증감표\n\n(포스격차) (주는 피해) (받는 피해)\n\n-95이하\t5%\t200%\n-90\t10%\t200%\n-80\t20%\t200%\n-70\t30%\t200%\n-60\t40%\t200%\n-50\t50%\t150%\n-40\t60%\t150%\n-30\t70%\t150%\n-20\t80%\t150%\n-10\t90%\t150%\n0\t100%\t100%\n10\t105%\t100%\n20\t110%\t100%\n30\t115%\t100%\n40\t120%\t100%\n50이상\t125%\t100%";
